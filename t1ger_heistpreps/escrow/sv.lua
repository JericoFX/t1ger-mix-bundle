...
RegisterServerEvent('t1ger_heistpreps:hacking:cancelDecrypting')
AddEventHandler('t1ger_heistpreps:hacking:cancelDecrypting', function(type, num)
    Config.Jobs[type][num].cache.decrypting = nil
    SyncJobCache(type, num)
end)
