...
-- General Settings:
Config.ProgressBars = true -- enable ox_lib progress circle interactions
Config.UsePhoneMSG = true  -- use phone msg instead of notify during job
...
Config.PoliceSettings = {
    ...
    requiredCops = 2,
    onDutyOnly = true -- only count on duty cops when true
}
...
Config.JobNPC = {
    ...
    jobFees = {amount = 500, account = 'cash'}, -- amount of money to start job, account can be cash/bank
    targetIcon = 'fa-solid fa-sack-dollar',
    targetLabel = 'Request gold job',
    targetRadius = 2.0
}
...
Config.Smeltery = {
    [1] = {
        ...
        targetLabel = 'Smelt gold watches',
        targetRadius = 1.5,
    }
}
...
Config.Exchange = {
    [1] = {
        ...
        targetLabel = 'Exchange gold bars',
        targetRadius = 1.25,
    }
}
...
Config.ExchangeSettings = {
    ...
    money = {
        ...
        account = 'cash' -- account to receive cash (cash/bank)
    }
}
