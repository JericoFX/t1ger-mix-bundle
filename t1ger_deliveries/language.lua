...
Lang = {
  -- Notifications:
        ...
        ['society_balance_unavailable'] = 'Unable to fetch the society balance right now.',
        ...
        ['society_vehicle_taken']   = 'Society owned vehicle taken out.',
        ['no_society_vehicles']     = 'No society vehicles available.',
        ['delivery_duty_boss']      = 'Your job has been set to boss for delivery.',
        ['delivery_duty_missing']   = 'You do not own any delivery companies to use this function.',

        -- Confirmations & input:
        ['confirm_purchase_title']  = 'Confirm Purchase | Price: $%s',
        ['confirm_purchase_content']= 'Are you sure you want to purchase this delivery company?',
        ['company_purchase_confirm']= 'Confirm the company purchase.',
        ['enter_company_name_title']= 'Enter Company Name',
        ['enter_company_name']      = 'Company Name',
        ['confirm_sale_title']      = 'Confirm Sale | Price: $%s',
        ['confirm_sale_content']    = 'Are you sure you want to sell this delivery company?',
        ['company_sell_confirm']    = 'Confirm the company sale.',
        ['rename_company_title']    = 'Enter Company Name',
        ...
        ['menu_boss']               = 'Boss Menu',
        ['menu_company_level']      = 'Company Level',
        ['menu_request_job']        = 'Request Job',
        ['menu_shop_orders']        = 'Shop Orders',
        ['menu_company_title']      = 'Company [%s]',
        ['boss_actions']            = 'Boss Actions',
        ['boss_account_balance']    = 'Account Balance',
        ['state_yes']               = 'Yes',
        ['state_no']                = 'No',
        ['has_certificate']         = 'Has Certificate: %s',
        ['buy_certificate']         = 'Buy Certificate',
        ['company_level_title']     = 'Company Level: %s',
        ['job_value_description']   = 'Required Level: %s',
        ['select_job_value']        = 'Select Job Value',
        ['shop_order_label']        = 'Order to Shop [%s]',
        ...
        ['select_society_vehicle']  = 'Select Society Vehicle',
        ['select_rental_vehicle']   = 'Select Rental Vehicle',
        ['deposit_short']           = 'Deposit',

        -- Blips:
        ['trucking_blip']           = 'Delivery Route',
        ['delivery_blip']           = 'Parcel Delivery',
        ['return_blip']             = 'Return Vehicle',
}
